  ...
  <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
    ...
    <v-card :class="editMode ? 'editModeEnabled' : ''">
      ...
      <v-toolbar dark prominent color="primary">
        ...
        <v-text-field persistent-hint variant="solo" v-else @click:clear="onClear" density="compact"
          v-model="getSingleNote.title" hide-details="auto" :model-value="getSingleNote.title">
        </v-text-field>
